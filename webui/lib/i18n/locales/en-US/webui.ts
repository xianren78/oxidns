...
export const enUSWebui = {
  ...
  endpoints: {
    ...
    unknown: "Unknown",
    name: "Endpoint name",
    namePlaceholder: "Home, Singapore, Production…",
    add: "Add endpoint",
  ...
  settings: {
    ...
    backendCardDesc:
      "Manage OxiDNS endpoints and choose which instance this console controls. Auth credentials are managed through the login flow.",
    connected: "Connected",
    disconnected: "Disconnected",
