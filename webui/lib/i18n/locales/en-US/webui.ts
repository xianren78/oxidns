...
export const enUSWebui = {
  ...
  endpoints: {
    ...
    description: "Manage and switch between OxiDNS instances",
    ...
    switch: "Switch to this endpoint",
    online: "Online",
    offline: "Offline",
    checking: "Checking",
    unknown: "Not checked",
    ...
    removeDescription:
      'Endpoint "{name}" and its local credentials will be deleted.',
    overview: "Instance overview",
    emptyName: "Enter an endpoint name",
  },
  plugins: {
